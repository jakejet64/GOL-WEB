...
class UI {
    ...
    static addStyleMenuListeners() {
        ...
        document.querySelector('.saveStyle').addEventListener('click', () => {
            const root = document.documentElement;
            this.styles.addStyle(new _Style_js__WEBPACK_IMPORTED_MODULE_3__["default"](
